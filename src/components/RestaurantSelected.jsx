// RestaurantSelected component - displays selected restaurant info or "no selection" message
function RestaurantSelected({ selectedMcDonalds }) {
  console.log("RestaurantSelected component rendered !");
  if (selectedMcDonalds) {
    return (
      // Bottom panel with selected restaurant information
    ...
    return (
      // Bottom panel with "no selection" message
      <div className="absolute box-border flex flex-col justify-center p-5 rounded-t-[15px] shadow-[0_-4px_8px_rgba(0,0,0,0.6)] bottom-0 z-[1500] w-full bg-white">
